...
class DashboardPage(QWidget):
    ...
    def __init__(self, reduced_motion=False, parent=None):
        ...
        splitter.addWidget(_scroll_column(left, 310))
        ...
        splitter.addWidget(_scroll_column(center, 430))
        ...
        upper.addWidget(self.capabilities, 1)
        upper.addWidget(self.applications, 1)
        ...
        splitter.addWidget(_scroll_column(right, 470))

        splitter.setStretchFactor(0, 20)
        splitter.setStretchFactor(1, 39)
        splitter.setStretchFactor(2, 41)
        splitter.setSizes([330, 640, 670])
